...
struct BrewPackage: Identifiable, Codable, Equatable {
    ...
    // Performance: Memoized derived state to avoid redundant computations and I/O
...
class BrewManager: ObservableObject {
    ...
    /// Performance: Centralized rating updates to keep memory models and UserDefaults in sync.
