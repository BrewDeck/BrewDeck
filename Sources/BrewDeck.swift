...
struct BrewPackage: Identifiable, Codable, Equatable {
    ...
    // Performance optimizations: stored properties for expensive/frequent calculations
    ...
    /// Updates derived performance properties. Called on init and when versions change.
...
class BrewManager: ObservableObject {
    ...
    /// Centrally updates package rating, ensuring consistency between packages list, recommendations, and UserDefaults.
